...
//----------------------------------------------------------------------------------------------------------------------
    ...
    drawDialForHours() {
        ...
        (<HTMLInputElement>myCircle).onmousemove = function showCoordinates(event) {
...
function setMinute(y) {
    ...
    let a =  document.getElementById("setTime").value;
    let h = a.substring(0,3);
